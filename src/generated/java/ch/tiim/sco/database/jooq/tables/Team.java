...
public class Team extends TableImpl<TeamRecord> {
	...
	private static final long serialVersionUID = -359341233;
	...
	/**
	 * The column <code>team.team_id</code>.
	 */
	public final TableField<TeamRecord, Integer> TEAM_ID = createField("team_id", org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>team.name</code>.
	 */
	public final TableField<TeamRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.CLOB, this, "");
